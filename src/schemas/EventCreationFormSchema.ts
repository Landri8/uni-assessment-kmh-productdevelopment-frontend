...
export const EventCreationFormSchema = z.object({
    title: z.string().min(3, "Title must be at least 3 characters").max(200, "Title must be at most 50 characters"),
    type: z.string(),
...
export type EventCreationFormData = z.infer<typeof EventCreationFormSchema>;