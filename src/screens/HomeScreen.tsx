...
import { getLastThreeFeedbackListApi } from "../services/clientService";
import toast from "react-hot-toast";

function App() {
  const [feedbacks, setFeedbacks] = useState<FeedbackInfoModel[]>([]);

  const getLastThreeFeedback = () => {
    getLastThreeFeedbackListApi()
          ...
          <div className="flex flex-wrap items-center">
            <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
              ...
              <p className="mt-4 text-lg text-gray-600">
                Streamline your operations and enhance productivity with our
                intelligent virtual assistant solutions. Custom-tailored for
                your specific business needs.
              </p>
              <div className="mt-10">
                <Link
                  to={"/contactus"}
                  className="bg-green-400 text-white font-bold px-6 py-3 rounded-full hover:bg-green-400 transition duration-300 mr-4"
                >
                  Schedule Demo
                </Link>
                <Link
                  to={"/aboutus"}
                  className="bg-white text-gray-800 border border-gray-300 font-bold px-6 py-3 rounded-full hover:bg-gray-100 transition duration-300"
                >
                  Learn More
                </Link>
              </div>
          ...
          <div className="flex flex-wrap justify-center text-center mb-16">
            <div className="w-full lg:w-6/12 px-4">
              <h2 className="text-4xl font-bold">
                What Our AI Solutions Offer
              </h2>
              <p className="text-lg leading-relaxed m-4 text-gray-600">
                Our virtual assistants are designed to handle a variety of
          ...
          <div className="flex flex-wrap">
            <div className="w-full md:w-4/12 px-4 text-center mb-10">
              ...
              <p className="mt-2 mb-4 text-gray-600">
                Automate routine tasks, manage schedules, and streamline
                communications.
              </p>
            </div>
            <div className="w-full md:w-4/12 px-4 text-center mb-10">
              ...
              <p className="mt-2 mb-4 text-gray-600">
                Provide 24/7 customer support with intelligent responses and
            ...
            <div className="w-full md:w-4/12 px-4 text-center mb-10">
              ...
              <p className="mt-2 mb-4 text-gray-600">
                Interpret complex data sets and generate actionable insights for
                your business.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center">
            <div className="w-full md:w-6/12 px-4 mr-auto ml-auto text-center">
              ...
              <p className="text-lg leading-relaxed mb-8 text-gray-600">
                Schedule a personalized demo today and see how our AI solutions
                can address your specific needs.
              </p>
              <Link
                to={"/contactus"}
                className="bg-green-400 text-white font-bold px-6 py-3 rounded-full hover:bg-green-400 transition duration-300 inline-flex items-center"
              >
                Schedule Demo
